...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(m.chat, {
            image: { url: "https://files.catbox.moe/1m225t.jpg" },
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "𓆩𝗡𝗢𝗩𝗔-𝗫𝗠𝗗𓆪";
            const imageUrl = "https://files.catbox.moe/1m225t.jpg"; // Replace with the actual image URL
