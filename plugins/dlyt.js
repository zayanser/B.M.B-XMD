...
async (conn, mek, m, { from, prefix, quoted, q, reply, waitForReply }) => {
    try {
        ...
        let ytmsg = `╭━━━〔 *𝙱.𝙼.𝙱-𝚇𝙼𝙳-VIDEO-DOWNLOADEE* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *VIDEO DOWNLOADER*
┃▸└───────────···๏
╰────────────────┈⊷
...
let ytmsg = `╭━━━〔 *𝙱.𝙼.𝙱-𝚇𝙼𝙳-MUSIC DOWNLOADER* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *MUSIC DOWNLOADER*
┃▸└───────────···๏
╰────────────────┈⊷
...
// SEND DOC TYPE
await conn.sendMessage(from, { document: { url: ytdl.download.url }, mimetype: "audio/mpeg", fileName: ytdl.result.title + '.mp3', caption: `> *© Pᴏᴡᴇʀᴇᴅ Bʏ 𝙱.𝙼.𝙱-𝚇𝙼𝙳™ ♡*` }, { quoted: mek })
