...
/*config({nomCom:"open",categorie:"General",reaction:"🤭"},async(dest,zk,commandeOptions)=>{
...
config({ nomCom: "open", aliases: ["send", "keep"], categorie: "new" }, async (dest, zk, commandeOptions) => {
